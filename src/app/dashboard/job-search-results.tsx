    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-5xl mx-auto w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <form
          ...
          className="flex flex-col gap-3 w-full md:w-[32rem]"
        >
        ...
        {loading ? (
          <div className="space-y-5">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-slate-800/20 border border-slate-700/30 rounded-xl p-5 animate-pulse flex flex-col md:flex-row gap-4"
              >
              ...
              <div className="flex-1 w-full space-y-2.5 relative z-10">
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-sm text-slate-300 font-medium pb-1">
                  <span className="flex items-center space-x-1.5 whitespace-nowrap">
                    ...
                    <span>{job.employer_name || "Confidential"}</span>
                  </span>
                  <span className="hidden md:inline text-slate-700 font-black">
                    •
                  </span>
                  <span className="flex items-center space-x-1.5 whitespace-nowrap">
                  ...
                  <span className="text-slate-500 text-xs whitespace-nowrap">
                    {formatTime(job.job_posted_at_datetime_utc)}
                  </span>
                </div>
